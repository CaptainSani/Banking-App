...
public class BankStatementImpl {
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPTable statementsInfo = new PdfPTable(1);
        ...
        statementsInfo.addCell(dateFrom);
        statementsInfo.addCell(statement);
        statementsInfo.addCell(dateTo);
        statementsInfo.addCell(name);
        statementsInfo.addCell(space);
        statementsInfo.addCell(address);


        document.add(bankInfoTable);
        document.add(statementsInfo);
